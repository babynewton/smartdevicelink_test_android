...
import com.livio.sdltester.utils.WifiUtils;

public class SdlConnectionDialog extends BaseAlertDialog {
	...
	private final DialogInterface.OnClickListener okButtonListener = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			boolean ipAddressValid = WifiUtils.validateIpAddress(ipAddress);
			boolean ipPortValid = WifiUtils.validateTcpPort(ipPort);
			
			IpAddress result = null;
			
			if(ipAddressValid && ipPortValid){
				result = new IpAddress(ipAddress, ipPort);
			}
