...
public class PerformInteractionDialog extends BaseOkCancelDialog implements OnCheckedChangeListener, OnSeekBarChangeListener{
	...
	private static final int MINIMUM_ALERT_TONE_TIME = 50; // 5.0 seconds
	private static final int MAXIMUM_ALERT_TONE_TIME = 1000;// 100.0 seconds
	...
	private static final int DEFAULT_TONE_DURATION = 100;  // 10.0 seconds
	...
	private void setupViews(final List<MenuItem> interactionSets){
		...
		seek_timeoutDuration.setProgress(DEFAULT_TONE_DURATION);
	}
